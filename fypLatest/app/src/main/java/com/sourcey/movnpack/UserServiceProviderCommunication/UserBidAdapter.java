...
public class UserBidAdapter extends ArrayAdapter<BidViewModel> implements View.OnClickListener{

    private ArrayList<BidViewModel> dataSet;
    Context mContext;
    ...
    public UserBidAdapter(ArrayList<BidViewModel> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        BidViewModel dataModel=(BidViewModel)object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BidViewModel dataModel = getItem(position);
        ...
        viewHolder.titleTextView.setText(dataModel.getCatTitle());
        viewHolder.messageInitialsTextView.setText(dataModel.getMessageInitials());
